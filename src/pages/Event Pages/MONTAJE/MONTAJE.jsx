...
function MONTAJE() {
    ...
    const handleRegisterClick = () => {
        window.open("https://forms.gle/ZkNf6QYnY395xfbQ8", "_blank");
    };
                    ...
                    <div className="mt-6 text-justify">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p>
                                    Participants will have one round to showcase their work. Simply submit your video through our
                                    Google Form, and contribute your voice to the themes “No poverty”,”Quality Education” and “Life below
                                    Water”. This is an opportunity to use your creative talents to make a difference, raise awareness, and
                                    inspire action on issues that matter.
                                </p>
                            </div>
                            {/* <div>
